...
def addMiniIso(process, options):
    ...
    process.probeEleMiniIsoEffArea.isolationConeDefinitions[0].effAreaFile = cms.FileInPath("RecoEgamma/ElectronIdentification/data/Run3_Winter22/effAreaElectrons_cone03_pfNeuHadronsAndPhotons_122X.txt")
    ...
    process.probeLowPtEleMiniIsoEffArea.isolationConeDefinitions[0].effAreaFile = cms.FileInPath("RecoEgamma/ElectronIdentification/data/Run3_Winter22/effAreaElectrons_cone03_pfNeuHadronsAndPhotons_122X.txt")